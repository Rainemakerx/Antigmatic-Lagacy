package com.integral.anticlimacticlagacy.client.renderers;
...
public abstract class RenderTypes extends RenderType {
	...
	public static RenderType unlit(ResourceLocation textureLocation) {
		...
		return RenderType.create("anticlimactic_entity_unlit", DefaultVertexFormat.NEW_ENTITY, GL11.GL_QUADS, 256, true, false, renderState);
	}
	...
	public static RenderType thyUnlit() {
		CompositeState renderState = CompositeState.builder()
				...
				.createCompositeState(true);
		return RenderType.create("anticlimactic_block_unlit", DefaultVertexFormat.BLOCK, 7, 262144, true, true, renderState);
	}
