...
public class RevelationTomeToast implements Toast {
	...
	public Visibility render(PoseStack ms, ToastComponent toastGui, long delta) {
		...
		toastGui.getMinecraft().font.draw(ms, I18n.get("anticlimacticlagacy.toasts.revelationTome.title", this.xpPoints), 30, 7, -11534256);
		toastGui.getMinecraft().font.draw(ms, I18n.get("anticlimacticlagacy.toasts.revelationTome.text", this.revelationPoints), 30, 17, -16777216);
