package com.integral.anticlimacticlagacy.entities;
...
/**
 * Modified version of Potion Entity designed specifically for Anticlimactic
 * Lagacy's potions.
 *
 * @author Integral
 */
...
public class AnticlimacticPotionEntity extends ThrowableItemProjectile implements ItemSupplier {
	...
	public AnticlimacticPotionEntity(EntityType<AnticlimacticPotionEntity> type, Level world) {
		super(type, world);
	}

	public AnticlimacticPotionEntity(Level world, LivingEntity entity) {
		super(AnticlimacticPotionEntity.TYPE, entity, world);
	}

	public AnticlimacticPotionEntity(Level world, double x, double y, double z) {
		super(AnticlimacticPotionEntity.TYPE, x, y, z, world);
	}

	@Override
	protected void defineSynchedData() {
		this.getEntityData().define(AnticlimacticPotionEntity.ITEM, ItemStack.EMPTY);
	}

	@Override
	public ItemStack getItem() {
		ItemStack itemstack = this.getEntityData().get(AnticlimacticPotionEntity.ITEM);
	...
	public void setItem(ItemStack stack) {
		this.getEntityData().set(AnticlimacticPotionEntity.ITEM, stack.copy());
	}
