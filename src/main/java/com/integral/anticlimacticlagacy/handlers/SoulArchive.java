...
public class SoulArchive {
	...
	public void save() {
		try {
			...
			AnticlimacticLagacy.logger.fatal("FAILED TO SAVE FILE: " + this.saveFile);
	...
	public void load() {
		try {
			...
			AnticlimacticLagacy.logger.fatal("FAILED TO LOAD FILE: " + this.saveFile);
			throw new RuntimeException(ex);
		}
	}
	...
	private void synchronize() {
		ServerLifecycleHooks.getCurrentServer().getPlayerList().getPlayers().forEach(player -> {
			if (SuperpositionHandler.hasCurio(player, AnticlimacticLagacy.soulCompass)) {
