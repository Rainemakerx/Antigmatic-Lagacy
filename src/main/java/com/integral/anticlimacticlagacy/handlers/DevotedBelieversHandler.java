...
public final class DevotedBelieversHandler {
	...
	private static Map<String, UUID> loadDevotedBelievers() {
		try {
			...
			logger.info("Successfully fetched the list of devoted believers from Anticlimactic Legacy's repository.");
			...
			logger.error("Encountered exception when trying to fetch devoted believers from Anticlimactic Legacy's repository:");
			logger.catching(ex);
