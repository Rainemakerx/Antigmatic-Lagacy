...
import com.integral.anticlimacticlagacy.packets.clients.PacketGenericParticleEffect.Effect;
...
public class GuardianHeart extends ItemBase implements ICursed, Vanishable {
	...
	public void appendHoverText(ItemStack stack, Level worldIn, List<Component> list, TooltipFlag flagIn) {
		if (Screen.hasShiftDown()) {
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.guardianHeart1", ChatFormatting.GOLD, abilityRange);
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.guardianHeart2");
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.guardianHeart3");
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.void");
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.guardianHeart4");
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.guardianHeart5", ChatFormatting.GOLD, abilityRange);
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.guardianHeart6");
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.guardianHeart7");
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.guardianHeart8", ChatFormatting.GOLD, enrageRange);
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.guardianHeart9");
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.guardianHeart10");
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.void");
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.guardianHeart11");
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.void");
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.guardianHeart12", ChatFormatting.GOLD, (abilityCooldown.getValue()/20.0));
		} else {
