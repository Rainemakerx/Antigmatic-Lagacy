	...
	public void appendHoverText(ItemStack stack, Level world, List<Component> list, TooltipFlag flag) {
		if (Screen.hasShiftDown()) {
			if (Minecraft.getInstance().player != null && SuperpositionHandler.isTheCursedOne(Minecraft.getInstance().player)) {
				ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.theInfinitum2");
				ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.theInfinitum3");
				ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.void");
			}

			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.theInfinitum4", ChatFormatting.GOLD, bossDamageBonus + "%");
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.theInfinitum5", ChatFormatting.GOLD, knockbackBonus + "%");
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.theInfinitum6", ChatFormatting.GOLD, lifestealBonus + "%");
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.void");
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.theInfinitum7");
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.void");
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.theInfinitum8");
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.void");
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.theInfinitum9");
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.theInfinitum10");
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.void");
			ItemLoreHelper.indicateWorthyOnesOnly(list);
		} else {
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.theInfinitum1");
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.void");
