...
public class ForbiddenFruit extends ItemBase implements Vanishable {
	...
	public void appendHoverText(ItemStack stack, @Nullable Level worldIn, List<Component> list, TooltipFlag flagIn) {
		if (Screen.hasShiftDown()) {
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.forbiddenFruit1");
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.forbiddenFruit2");
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.forbiddenFruit3", ChatFormatting.GOLD, regenerationSubtraction+"%");
		} else {
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.forbiddenFruitLore");
