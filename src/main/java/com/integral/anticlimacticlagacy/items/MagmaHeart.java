...
public class MagmaHeart extends ItemSpellstoneCurio implements ISpellstone {
	...
	public MagmaHeart() {
		...
		this.setRegistryName(new ResourceLocation(anticlimacticlagacy.MODID, "magma_heart"));
	...
	public void appendHoverText(ItemStack stack, @Nullable Level worldIn, List<Component> list, TooltipFlag flagIn) {
		...
		if (Screen.hasShiftDown()) {
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.magmaHeart1");
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.magmaHeart2");
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.void");
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.magmaHeartCooldown", ChatFormatting.GOLD, ((spellstoneCooldown.getValue())) / 20.0F);
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.void");
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.magmaHeart3");
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.magmaHeart4");
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.magmaHeart5");
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.magmaHeart6");
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.magmaHeart7");
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.magmaHeart8");
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.magmaHeart9");
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.magmaHeart10");
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.magmaHeart11");
		} else {
