...
public class SuperMagnetRing extends MagnetRing {
	...
	public void appendHoverText(ItemStack stack, @Nullable Level worldIn, List<Component> list, TooltipFlag flagIn) {
		...
		if (Screen.hasShiftDown()) {
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.superMagnetRing1");
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.superMagnetRing2", ChatFormatting.GOLD, range.getValue());
			ItemLoreHelper.addLocalizedString(list, invertShift.getValue() ? "tooltip.anticlimacticlagacy.superMagnetRing3_alt" : "tooltip.anticlimacticlagacy.superMagnetRing3");
		} else {
