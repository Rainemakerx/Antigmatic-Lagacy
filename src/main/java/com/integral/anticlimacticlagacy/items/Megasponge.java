...
public class Megasponge extends ItemBaseCurio implements Vanishable {
	...
	public void appendHoverText(ItemStack stack, @Nullable Level worldIn, List<Component> list, TooltipFlag flagIn) {
		...
		if (Screen.hasShiftDown()) {
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.megaSponge1");
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.megaSponge2");
		} else {
