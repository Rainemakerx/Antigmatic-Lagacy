...
import com.integral.anticlimacticlagacy.crafting.BindToPlayerRecipe.IBound;
...
public class WormholePotion extends ItemBase implements IBound {
	...
	public WormholePotion() {
		...
		this.setRegistryName(new ResourceLocation(AnticlimacticLagacy.MODID, "wormhole_potion"));
	}
	...
	public void appendHoverText(ItemStack stack, @Nullable Level worldIn, List<Component> list, TooltipFlag flagIn) {
		if (Screen.hasShiftDown()) {
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.wormholePotion1");
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.wormholePotion2");
		} else {
