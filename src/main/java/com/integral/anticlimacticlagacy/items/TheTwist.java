	...
	public void appendHoverText(ItemStack stack, Level world, List<Component> list, TooltipFlag flag) {
		if (Screen.hasShiftDown()) {
			if (Minecraft.getInstance().player != null && SuperpositionHandler.isTheCursedOne(Minecraft.getInstance().player)) {
				ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.theTwist4");
				ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.theTwist5");
				ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.void");
			}
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.theTwist6", ChatFormatting.GOLD, bossDamageBonus + "%");
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.theTwist7", ChatFormatting.GOLD, knockbackBonus + "%");
		} else {
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.theTwist1");
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.theTwist2");
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.void");
