...
public class SoulCompass extends ItemBase implements ICursed {
	...
	public SoulCompass() {
		...
		this.setRegistryName(new ResourceLocation(AnticlimacticLagacy.MODID, "soul_compass"));
	}
	...
	public void appendHoverText(ItemStack stack, Level world, List<Component> list, TooltipFlag flag) {
		if (Screen.hasShiftDown()) {
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.soulCompass1");
		} else {
