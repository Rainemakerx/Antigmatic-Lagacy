...
public class VoidPearl extends ItemSpellstoneCurio implements ISpellstone {
	...
	public void appendHoverText(ItemStack stack, @Nullable Level worldIn, List<Component> list, TooltipFlag flagIn) {
		...
		if (Screen.hasShiftDown()) {
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.voidPearl1");
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.voidPearl2");
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.void");
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.voidPearlCooldown", ChatFormatting.GOLD, ((spellstoneCooldown.getValue())) / 20.0F);
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.void");
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.voidPearl3");
			// These lines describe hunger negation trait that was removed since release 2.5.0
			//ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.voidPearl4");
			//ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.voidPearl5");
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.voidPearl6");
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.voidPearl7");
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.voidPearl8");
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.voidPearl9");
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.voidPearl10");
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.voidPearl11");
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.voidPearl12");
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.voidPearl13", ChatFormatting.GOLD, undeadProbability.getValue().asPercentage() + "%");
			ItemLoreHelper.addLocalizedString(list, "tooltip.anticlimacticlagacy.voidPearl14");
		} else {
	...
	public void curioTick(SlotContext context, ItemStack stack) {
		if (context.entity() instanceof Player player) {
			...
			if (player.tickCount % 10 == 0) {
				...
				boolean hasAnimalGuide = SuperpositionHandler.hasItem(player, AnticlimacticLagacy.animalGuide);
				...
				for (LivingEntity victim : entities) {
					if (victim.level.getMaxLocalRawBrightness(victim.blockPosition(), 0) < 3 || (victim instanceof Phantom && !victim.isOnFire())) {
						if (hasAnimalGuide && AnticlimacticLagacy.animalGuide.isProtectedAnimal(victim)) {
							continue;
						}
