...
public class ItemLoreHelper {
	...
	public static void indicateCursedOnesOnly(List<Component> list) {
		...
		list.add(new TranslatableComponent("tooltip.anticlimacticlagacy.cursedOnesOnly1").withStyle(format));
		list.add(new TranslatableComponent("tooltip.anticlimacticlagacy.cursedOnesOnly2").withStyle(format));
	...
	public static void indicateBlessedOnesOnly(List<Component> list) {
		...
		list.add(new TranslatableComponent("tooltip.anticlimacticlagacy.blessedOnesOnly1").withStyle(format));
		list.add(new TranslatableComponent("tooltip.anticlimacticlagacy.blessedOnesOnly2").withStyle(format));
	...
	public static void indicateWorthyOnesOnly(List<Component> list) {
		...
		list.add(new TranslatableComponent("tooltip.anticlimacticlagacy.worthyOnesOnly1"));
		list.add(new TranslatableComponent("tooltip.anticlimacticlagacy.worthyOnesOnly2"));
		list.add(new TranslatableComponent("tooltip.anticlimacticlagacy.worthyOnesOnly3"));
		list.add(new TranslatableComponent("tooltip.anticlimacticlagacy.void"));
		list.add(new TranslatableComponent("tooltip.anticlimacticlagacy.worthyOnesOnly4").withStyle(format).append(new TextComponent(" " + SuperpositionHandler.getSufferingTime(player)).withStyle(ChatFormatting.LIGHT_PURPLE)));
	...
	public static class AnvilParser {
		...
		private static String parseFormatting(String field) {
			String formatter = new TranslatableComponent("tooltip.anticlimacticlagacy.paragraph").getString();
			String subformat = new TranslatableComponent("tooltip.anticlimacticlagacy.subformat").getString();
