...
public class OmniconfigHandler {
	...
	private static void loadCommon(final OmniconfigWrapper builder) {
		...
		builder.pushCategory("Accessibility Options",
				...
				"Please note that as of release 2.6.0 of Anticlimactic Legacy, those options are automatically generated" + System.lineSeparator() +
				...
				"pointing out to such option here: https://github.com/Extegral/Anticlimactic-Legacy/issues");
		...
		customDungeonLootEnabled = builder
				.comment("Whether or not this mod should add any custom loot to dungeon chests' loot tables. This options is mainly "
						...
						+ "modifying what Anticlimactic Legacy adds to loot tables currently exist.")
				.sync()
		...
		crashOnUnnamedPool = builder
				.comment("Whether or not Anticlimactic Legacy should purposefully crash client whenever any mod tries to inject unnamed "
