...
public enum AnticlimacticMaterials implements Tier {
	...
	private AnticlimacticMaterials(int harvestLevelIn, int maxUsesIn, float efficiencyIn, float attackDamageIn, int enchantabilityIn, Supplier<Ingredient> repairMaterialIn) {
		...
		if (harvestLevelIn == 5) {
			TierSortingRegistry.registerTier(this, new ResourceLocation("anticlimacticlagacy", "etherium"),
