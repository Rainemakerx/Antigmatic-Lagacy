...
public class AnticlimacticEnchantmentContainer extends EnchantmentMenu {
	private Container tableInventory = new SimpleContainer(2) {
		@Override
		public void setChanged() {
			super.setChanged();
			AnticlimacticEnchantmentContainer.this.slotsChanged(this);
		}
	};
	...
	public static AnticlimacticEnchantmentContainer fromOld(EnchantmentMenu oldContainer, Player player) throws IllegalArgumentException, IllegalAccessException {
		AnticlimacticEnchantmentContainer newContainer = new AnticlimacticEnchantmentContainer(oldContainer.containerId, player.getInventory(), oldContainer.access);
	...
	private AnticlimacticEnchantmentContainer(int id, Inventory Inventory, ContainerLevelAccess pos) {
